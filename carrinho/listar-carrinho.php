...
echo '
                        ...
                        <div class="cart-inline-header">
                          ...
                          <h6 class="cart-inline-title ml-1">Valor total: R$<span id="valor_total"></span></h6>
                        </div>
                        ...
                        echo '<div class="cart-inline-item">
                            <div class="unit align-items-center">
                              ...
                              <div class="unit-body">
                                <h6 class="cart-inline-name"><a>'.$nome_produto.'</a><a href="" id="btn-deletar" onclick="deletarCarrinho('.$id_carrinho.')" class="ml-2"><img src="images/delete-icon.png" width=20></a></h6>                                
                                <div>
