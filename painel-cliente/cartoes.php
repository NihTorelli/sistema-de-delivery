...
<span><b>Como Funciona?</b></span><br>
 <small><span class="text-muted">Após efetuar 5 compras no delivery através do site, você ganha uma bebida de sua preferência! </span></small>
...
<div class="row">
      ...
      <?php if($carimbos > 0){ ?>
        ...
        <img src="../images/carimbado.png" width="90">
      </div>
     <?php }else{ ?>
       <div class="col-md-2 ml-2" align="center">
        <img src="../images/nao-carimbado.png" width="90">
      </div>
     <?php } ?>
