...
if($descricao_longa == ''){
	...
	$res = $pdo->prepare("INSERT into produtos (nome, descricao, descricao_longa, valor, categoria, imagem, nome_url, combo) values (:nome, :descricao, :descricao_longa, :valor, :categoria, :imagem, :nome_url, :combo)");
