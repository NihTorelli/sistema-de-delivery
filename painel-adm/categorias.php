			...
			<div class="modal-body">
				...
				<form id="<?php echo $form ?>" method="post" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="nome" placeholder="Nome da Categoria" name="nome" value="<?php echo @$nome ?>" required>
					</div>

					<div class="form-group">
						<label for="descricao">Descrição</label>
						<input type="text" class="form-control" id="descricao" placeholder="Descrição da Categoria" name="descricao" value="<?php echo @$descricao ?>" required>
					</div>
...
<!--CHAMADA DA MODAL PARA INSERÇÃO OU EDIÇÃO-->
<?php
...
<!--AJAX PARA INSERÇÃO DAS IMAGENS -->
